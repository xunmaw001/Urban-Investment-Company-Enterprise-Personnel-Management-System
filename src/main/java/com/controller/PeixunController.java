...
//                            peixunEntity.setPeixunName(data.get(0));                    //培训名称 要改的
//                            peixunEntity.setPeixunTypes(Integer.valueOf(data.get(0)));   //培训类型 要改的
//                            peixunEntity.setPeixunKaishiTime(new Date(data.get(0)));          //培训开始时间 要改的
//                            peixunEntity.setPeixunJieshuTime(new Date(data.get(0)));          //培训结束时间 要改的
//                            peixunEntity.setPeixunContent("");//照片
