...
//            return R.error(511,"永远不会进入");
        ...
        if("".equals(yuangong.getHetongFile()) || "null".equals(yuangong.getHetongFile())){
                yuangong.setHetongFile(null);
        }
        if(yuangongEntity==null){
...
//                            yuangongEntity.setXueliTypes(Integer.valueOf(data.get(0)));   //学历 要改的
//                            yuangongEntity.setZhuanyezhiwuTypes(Integer.valueOf(data.get(0)));   //专业职务 要改的
//                            yuangongEntity.setHetongTypes(Integer.valueOf(data.get(0)));   //合同类型 要改的
//                            yuangongEntity.setHetongFile(data.get(0));                    //合同文件 要改的
//                            yuangongEntity.setHetongQiandingTime(new Date(data.get(0)));          //合同签订时间 要改的
//                            yuangongEntity.setHetongJieshuTime(new Date(data.get(0)));          //合同到期时间 要改的
//                            yuangongEntity.setZhengzhiTypes(Integer.valueOf(data.get(0)));   //政治面貌 要改的
//                            yuangongEntity.setYuangongXuexiao(data.get(0));                    //毕业院校 要改的
//                            yuangongEntity.setGangweiTypes(Integer.valueOf(data.get(0)));   //岗位 要改的
//                            yuangongEntity.setHukou(data.get(0));                    //户口所在地 要改的
//                            yuangongEntity.setHunyinTypes(Integer.valueOf(data.get(0)));   //婚姻 要改的
//                            yuangongEntity.setZhuzhi(data.get(0));                    //家庭住址 要改的
//                            yuangongEntity.setGongzuoTime(new Date(data.get(0)));          //参加工作时间 要改的
//                            yuangongEntity.setMinzu(data.get(0));                    //民族 要改的
//                            yuangongEntity.setRuzhiTime(new Date(data.get(0)));          //入职时间 要改的
//                            yuangongEntity.setRudangTime(new Date(data.get(0)));          //入党时间 要改的
//                            yuangongEntity.setZhuanyeTypes(Integer.valueOf(data.get(0)));   //专业 要改的
