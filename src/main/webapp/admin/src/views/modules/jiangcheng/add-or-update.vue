    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="奖惩名称" prop="jiangchengName">
                       <el-input v-model="ruleForm.jiangchengName"
                                 placeholder="奖惩名称" clearable  :readonly="ro.jiangchengName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="奖惩名称" prop="jiangchengName">
                           <el-input v-model="ruleForm.jiangchengName"
                                     placeholder="奖惩名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="奖惩详情" prop="jiangchengContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiangchengContent" label="奖惩详情" prop="jiangchengContent">
