        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学历" prop="xueliTypes">
                        <el-select v-model="ruleForm.xueliTypes" :disabled="ro.xueliTypes" placeholder="请选择学历">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="专业职务" prop="zhuanyezhiwuTypes">
                        <el-select v-model="ruleForm.zhuanyezhiwuTypes" :disabled="ro.zhuanyezhiwuTypes" placeholder="请选择专业职务">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="合同类型" prop="hetongTypes">
                        <el-select v-model="ruleForm.hetongTypes" :disabled="ro.hetongTypes" placeholder="请选择合同类型">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="合同签订时间" prop="hetongQiandingTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.hetongQiandingTime"
                                type="datetime"
                                placeholder="合同签订时间"
                                :disabled="ro.hetongQiandingTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.hetongQiandingTime" label="合同签订时间" prop="hetongQiandingTime">
                            <span v-html="ruleForm.hetongQiandingTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="合同到期时间" prop="hetongJieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.hetongJieshuTime"
                                type="datetime"
                                placeholder="合同到期时间"
                                :disabled="ro.hetongJieshuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.hetongJieshuTime" label="合同到期时间" prop="hetongJieshuTime">
                            <span v-html="ruleForm.hetongJieshuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="毕业院校" prop="yuangongXuexiao">
                       <el-input v-model="ruleForm.yuangongXuexiao"
                                 placeholder="毕业院校" clearable  :readonly="ro.yuangongXuexiao"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="岗位" prop="gangweiTypes">
                        <el-select v-model="ruleForm.gangweiTypes" :disabled="ro.gangweiTypes" placeholder="请选择岗位">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="户口所在地" prop="hukou">
                       <el-input v-model="ruleForm.hukou"
                                 placeholder="户口所在地" clearable  :readonly="ro.hukou"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="婚姻" prop="hunyinTypes">
                        <el-select v-model="ruleForm.hunyinTypes" :disabled="ro.hunyinTypes" placeholder="请选择婚姻">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家庭住址" prop="zhuzhi">
                       <el-input v-model="ruleForm.zhuzhi"
                                 placeholder="家庭住址" clearable  :readonly="ro.zhuzhi"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="参加工作时间" prop="gongzuoTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.gongzuoTime"
                                type="datetime"
                                placeholder="参加工作时间"
                                :disabled="ro.gongzuoTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gongzuoTime" label="参加工作时间" prop="gongzuoTime">
                            <span v-html="ruleForm.gongzuoTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="入党时间" prop="rudangTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.rudangTime"
                                type="datetime"
                                placeholder="入党时间"
                                :disabled="ro.rudangTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.rudangTime" label="入党时间" prop="rudangTime">
                            <span v-html="ruleForm.rudangTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    bumenTypes: false,
                    xueliTypes: false,
                    zhuanyezhiwuTypes: false,
                    hetongTypes: false,
                    hetongFile: false,
                    hetongQiandingTime: false,
                    hetongJieshuTime: false,
                    zhengzhiTypes: false,
                    yuangongXuexiao: false,
                    gangweiTypes: false,
                    hukou: false,
                    hunyinTypes: false,
                    zhuzhi: false,
