                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/chengtourenshiguanli/upload/yuangongMuBan.xls"
                        >批量导入员工数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yuangong','导入导出')"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                bumenTypes : null,
                xueliTypes : null,
                zhuanyezhiwuTypes : null,
                hetongTypes : null,
                hetongFile : null,
                hetongQiandingTime : null,
                hetongJieshuTime : null,
                zhengzhiTypes : null,
                yuangongXuexiao : null,
                gangweiTypes : null,
                hukou : null,
                hunyinTypes : null,
                zhuzhi : null,
